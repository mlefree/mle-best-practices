...
for (const project of allProjects) {
  ...
  if (isExcluded) {
    ...
    // Update .gitignore file if project has .gitignore in bpstatus.json status
    if (bpStatus.status && bpStatus.status['.gitignore']) {
      console.log(`${project.projectName} has .gitignore in bpstatus.json status, updating .gitignore file...`);
