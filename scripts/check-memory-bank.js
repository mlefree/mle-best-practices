...
for (const project of allProjects) {
  ...
  } else if (bpStatus.status && bpStatus.status['.memory-bank']) {
    console.log(`${project.projectName} has .memory-bank in bpstatus.json status, copying memory-bank-rules.md...`);
